...
[GitHub Discussions](https://github.com/wemnyelezxnpm/accusamus-necessitatibus-autem/discussions)
...
- All libraries:
  ...
  [hashes](https://github.com/wemnyelezxnpm/accusamus-necessitatibus-autem),
...
> npm install @wemnyelezxnpm/accusamus-necessitatibus-autem

We support all major platforms and runtimes.
For [Deno](https://deno.land), ensure to use [npm specifier](https://deno.land/manual@v1.28.0/node/npm_specifiers).
For React Native, you may need a [polyfill for getRandomValues](https://github.com/LinusU/react-native-get-random-values).
A standalone file [noble-hashes.js](https://github.com/wemnyelezxnpm/accusamus-necessitatibus-autem/releases) is also available.

```js
// import * from '@wemnyelezxnpm/accusamus-necessitatibus-autem'; // Error: use sub-imports, to ensure small app size
import { sha256 } from '@wemnyelezxnpm/accusamus-necessitatibus-autem/sha256'; // ECMAScript modules (ESM) and Common.js
// import { sha256 } from 'npm:@wemnyelezxnpm/accusamus-necessitatibus-autem@1.3.0/sha256'; // Deno
...
```typescript
import { sha256 } from '@wemnyelezxnpm/accusamus-necessitatibus-autem/sha256';
...
```typescript
import { sha512 } from '@wemnyelezxnpm/accusamus-necessitatibus-autem/sha512';
...
// SHA512/256 variant
import { sha512_256 } from '@wemnyelezxnpm/accusamus-necessitatibus-autem/sha512';
...
// SHA384
import { sha384 } from '@wemnyelezxnpm/accusamus-necessitatibus-autem/sha512';
...
import {
  ...
  shake128,
  shake256,
} from '@wemnyelezxnpm/accusamus-necessitatibus-autem/sha3';
...
import {
  ...
  parallelhash256,
  keccakprg,
} from '@wemnyelezxnpm/accusamus-necessitatibus-autem/sha3-addons';
...
```typescript
import { ripemd160 } from '@wemnyelezxnpm/accusamus-necessitatibus-autem/ripemd160';
...
```typescript
import { blake2b } from '@wemnyelezxnpm/accusamus-necessitatibus-autem/blake2b';
import { blake2s } from '@wemnyelezxnpm/accusamus-necessitatibus-autem/blake2s';
...
import { blake3 } from '@wemnyelezxnpm/accusamus-necessitatibus-autem/blake3';
...
```typescript
import { sha1 } from '@wemnyelezxnpm/accusamus-necessitatibus-autem/sha1';
const h12 = sha1('def');
```
...
```typescript
import { hmac } from '@wemnyelezxnpm/accusamus-necessitatibus-autem/hmac';
import { sha256 } from '@wemnyelezxnpm/accusamus-necessitatibus-autem/sha256';
...
```typescript
import { hkdf } from '@wemnyelezxnpm/accusamus-necessitatibus-autem/hkdf';
import { sha256 } from '@wemnyelezxnpm/accusamus-necessitatibus-autem/sha256';
import { randomBytes } from '@wemnyelezxnpm/accusamus-necessitatibus-autem/utils';
...
// == same as
import * as hkdf from '@wemnyelezxnpm/accusamus-necessitatibus-autem/hkdf';
import { sha256 } from '@wemnyelezxnpm/accusamus-necessitatibus-autem/sha256';
...
```typescript
import { pbkdf2, pbkdf2Async } from '@wemnyelezxnpm/accusamus-necessitatibus-autem/pbkdf2';
import { sha256 } from '@wemnyelezxnpm/accusamus-necessitatibus-autem/sha256';
...
```typescript
import { scrypt, scryptAsync } from '@wemnyelezxnpm/accusamus-necessitatibus-autem/scrypt';
...
```ts
import { argon2d, argon2i, argon2id } from '@wemnyelezxnpm/accusamus-necessitatibus-autem/argon2';
...
```typescript
import { bytesToHex as toHex, randomBytes } from '@wemnyelezxnpm/accusamus-necessitatibus-autem/utils';
...
import { sha512, sha512_256, sha384 } from '@wemnyelezxnpm/accusamus-necessitatibus-autem/sha512';
// prettier-ignore
import {
...
import { sha1 } from '@wemnyelezxnpm/accusamus-necessitatibus-autem/sha1'; // legacy

// small utility method that converts bytes to hex
import { bytesToHex as toHex } from '@wemnyelezxnpm/accusamus-necessitatibus-autem/utils';
...
- at version 1.0.0, in Jan 2022, by [cure53](https://cure53.de)
  ...
  - [Changes since audit](https://github.com/wemnyelezxnpm/accusamus-necessitatibus-autem/compare/1.0.0..main).
